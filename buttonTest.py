...
GPIO.add_event_detect(18,GPIO.FALLING,callback=red_effect_button_callback)#,bouncetime=10) # Setup event on GPIO 18 rising edge
...
GPIO.add_event_detect(24,GPIO.FALLING,callback=blue_effect_button_callback)#,bouncetime=10) # Setup event on GPIO 24 rising edge
...
GPIO.add_event_detect(19,GPIO.FALLING,callback=score_red_button_callback)#,bouncetime=10) # Setup event on GPIO 19 rising edge
...
GPIO.add_event_detect(16,GPIO.FALLING,callback=score_blue_button_callback)#,bouncetime=10) # Setup event on GPIO 16 rising edge
